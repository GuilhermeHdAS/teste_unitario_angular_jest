...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'flavio', 'flavio@pic.com.br', '123', 'Flávio' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'flavio')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'almeida', 'almeida@pic.com.br', '123', 'Almeida' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'almeida')
`;
